...
public class MenuConsole {
    ...
    public void createMenu() {
        while (true) {
            ...
            System.out.println("| 5.Export Student To File.      |");
            System.out.println("| 6.Import Student From File.    |");
            ...
            if (choice == 7) {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        studentController.exportStudent();
                        break;
                    case 6:
                        studentController.importStudent();
                        break;
                    default:
                        // Do something. Please do something.
